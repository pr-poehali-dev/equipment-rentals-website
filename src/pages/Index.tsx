...
type Page = "home" | "about" | "catalog" | "terms" | "contacts" | "reviews";
type IconName = string;

const HERO_IMAGE = "https://cdn.poehali.dev/projects/90f3c006-fd48-4490-ba85-73fbd702f8a5/files/e6720968-72d8-4afe-a121-2ca6268e8d53.jpg";
...
const CATEGORIES = ["Все", "Землеройная", "Грузоподъёмная", "Складская", "Строительная", "Транспортная", "Дорожная", "Электрическая"];
